...
export const workExperiences: WorkExperience[] = [
  {
    ...
    descriptions: [
      "Responsible for developing new features and uplifting Zunia's Operational and Engagement Software.",
      "Responsible for managing the team members on product development and delivery when the tech lead is away.",
      "Develop and Execute software architecture solution design with tech leads, principal software engineer, head of engineering, and architect to produce high-quality products that run efficiently and meet client requirements.",
      "Documenting domain knowledge and software architecture",
      "Documenting product and technical decision-making",
      "Responsible for working closely with product manager, tech lead, head of engineering, principal engineer, and designers for product delivery and decision-making.",
      "Perform product presentation to the company's executive and the whole team Zunia team.",
      "Working with technologies such as PostgreSQL, PrismaORM, Typescript/JavaScript, React, NestJS, Express, ASP.NET Core, and Amazon Web Services at all times.",
      "Working with technologies such as React Ionic for mobile development for Android and iOS.",
      "Using AWS CDK for IaC to manage, test, build, and deploy app-level DevOps.",
      "Enhances CI/CD and rollback strategy with GitHub Actions and Workflows.",
      "Develop software with third-party integration.",
      "Work in a team of 1 Mid-level engineers, 2 Senior engineers, 2 Associate engineers, 1 Tech leads, 1 Product Manager, 1 Content, and 1 Designer",
    ],
  },
  {
